  ...
  document
    ...
    .forEach((t) => {
      ...
      if (e === c || i === n) {
        ...
        (e.open("GET", complianz.url + "consent-area/" + o + "/" + a, !0),
  ...
  .forEach((e) => {
    (e.addEventListener("click", (e) => {
      ...
      (t = t.classList.contains("cmplz-consent-area")
        ...
        (cmplz_set_service_consent((e = t.getAttribute("data-service")), !0),
...
((window.cmplz_get_cookie = function (t) {
  ...
  (window.cmplz_set_cookie = function (e, t, c) {
    ...
    "undefined" != typeof document &&
      ...
      (a = 0 < (a = cmplz_get_cookie_domain()).length ? ";domain=" + a : ""),
  ...
  (window.cmplz_highest_accepted_category = function () {
    ...
    for (let e = 0; e < c.length; e++) if (cmplz_in_array(c[e], t)) return c[e];
    return "functional";
  }));
let cmplz_set_category_as_body_class = () => {
    let c = document.body.classList;
    for (let e = c.length - 1; 0 <= e; e--)
      c[e].startsWith("cmplz-") && "cmplz-document" !== c[e] && c.remove(c[e]);
    var e = cmplz_accepted_categories(),
      ...
      e =
        ...
        c.add("cmplz-" + complianz.region, "cmplz-" + complianz.consenttype),
  ...
  (document.querySelectorAll(".cmplz-image").forEach((e) => {
    ...
    e.classList.contains("cmplz-processed") ||
      ...
      "lazy" === e.getAttribute("loading") &&
        (e.removeAttribute("loading"), e.setAttribute("data-deferlazy", 1)),
      null == o &&
  ...
  if (
    ...
    ((e =
      ...
      document.querySelectorAll(e).forEach((e) => {
        ...
        (e.parentNode.classList.contains("cmplz-blocked-content-notice") &&
          (e = e.parentNode),
          ...
          if (
            ...
            if ("LINK" === e) {
              ...
              c = t.getAttribute("data-cmplz-target")
                ...
                : "src";
              ("1" === cmplz_get_url_parameter(t.getAttribute(c), "autoplay") &&
                (e += "&autoplay=1"),
                t.getAttribute("data-deferlazy") &&
                  t.setAttribute("loading", "lazy"),
              ...
              t.classList.contains("cmplz-placeholder-element") &&
                (t.classList.add("cmplz-activated"),
                (e = t.getAttribute("data-placeholder_class_index")),
                t.classList.remove(
                  "cmplz-blocked-content-container",
                  "cmplz-placeholder-" + e,
                ));
    ...
    t = document.querySelectorAll(
      'script[data-category="' + o + '"], script[data-service="' + a + '"]',
    );
    (t.forEach((e) => {
      ...
      (t &&
        (c
          ...
          : 0 < e.innerText.length && (cmplz_waiting_inline_scripts[t] = e)),
          ...
          (n = e.getAttribute("data-cmplz-src"))
            ? (e.removeAttribute("type"),
              cmplz_is_waiting_script(cmplz_waiting_scripts, n) ||
                (e.getAttribute("data-post_scribe_id")
                  ? ((t = "#" + e.getAttribute("data-post_scribe_id")),
                    (c = document.querySelector(t)) &&
                      (c.innerHtml(""),
                      postscribe(t, "<script src=" + n + "><\/script>")))
            ...
            : 0 < e.innerText.length &&
              (cmplz_is_waiting_script(
                ...
                cmplz_run_script(e.innerText, o, a, "inline", e)));
      }),
...
function cmplz_run_after_all_scripts(e, t) {
  var c =
      "do_not_match" !== t && !cmplz_in_array(t, cmplz_fired_service_events),
...
((window.cmplz_accept_all = function () {
  ...
  (window.conditionally_show_banner = function () {
    ...
    if (cmplz_exists_service_consent()) {
      ...
      for (i in s)
        s.hasOwnProperty(i) &&
          ...
          (document
            .querySelectorAll('.cmplz-accept-service[data-service="' + l + '"]')
            .forEach((e) => {
              e.checked = !0;
            }),
    ...
    (cmplz_sync_category_checkboxes(),
      ...
      (n = new CustomEvent("cmplz_cookie_banner_data", { detail: complianz })),
      document.dispatchEvent(n),
      "" === cmplz_get_cookie("saved_categories") &&
        ("optin" !== complianz.consenttype && "optout" !== complianz.consenttype
          ? cmplz_track_status("no_warning")
          : cmplz_do_not_track() && cmplz_track_status("do_not_track")),
  ...
  (window.show_cookie_banner = function () {
    let t = complianz.disable_cookiebanner || cmplz_is_speedbot(),
      e = !1;
    ...
    var o = complianz.css_file
      ...
      o =
        (-1 !==
          complianz.css_file.indexOf("cookiebanner/css/defaults/banner") &&
          console.log(
        ...
        (c.onload = function () {
          ...
          !t &&
            ...
            (e = cmplz_banner.querySelector(".cmplz-close"))) &&
            e.focus();
        }),
            ...
            .forEach((e) => {
              ...
              for (t in (c.classList.add("cmplz-hidden"), n))
                n.hasOwnProperty(t) &&
                  ...
                  (c.setAttribute(
                    "href",
                    n[t].url + c.getAttribute("data-relative_url"),
                  ),
                  "{title}" === c.innerText &&
                    (c.innerText = cmplz_html_decode(n[t].title)),
  ...
  (window.cmplz_set_banner_status = function (e) {
    ...
    var c = new CustomEvent("cmplz_banner_status", { detail: e });
    (document.dispatchEvent(c),
      cmplz_start_clean(),
      "show" === e &&
        (c = cmplz_banner.querySelector(".cmplz-close")) &&
        c.focus());
  }),
...
function cmplz_integrations_init() {
  ...
  for (e in t)
    t.hasOwnProperty(e) && "1" === t[e][1] && cmplz_set_cookie(e, t[e][1], !1);
}
...
function cmplz_maybe_auto_redirect() {
  ...
  e &&
    !t &&
    ((e =
      window.location.href.split("#")[0] + "&cmplz-region=" + complianz.region),
  ...
  cmplz_add_event("click", ".cmplz-view-preferences", function (e) {
    ...
    (cmplz_banner = e.closest(".cmplz-cookiebanner"))
      ...
      ? (cmplz_banner.classList.remove("cmplz-categories-visible"),
        ...
        (cmplz_banner.querySelector(".cmplz-view-preferences").style.display =
          "block"),
        (cmplz_banner.querySelector(".cmplz-save-preferences").style.display =
          "none"))
      : (cmplz_banner.classList.add("cmplz-categories-visible"),
        ...
        (cmplz_banner.querySelector(".cmplz-save-preferences").style.display =
          "block"),
        (e = cmplz_banner.querySelector(".cmplz-categories .cmplz-category")) &&
...
function cmplz_do_cleanup() {
  var e;
  for (e of ["preferences", "statistics", "marketing"])
    if (!cmplz_has_consent(e) && cmplz_cookie_data.hasOwnProperty(e)) {
      var t,
        c,
        n = cmplz_cookie_data[e];
      for (t in n)
        if (!cmplz_has_service_consent(t, e))
          for (c of n[t]) (cmplz_clear_cookies(c), cmplz_clear_storage(c));
    }
}
...
function cmplz_equals(c, n) {
  if (
    (Array.isArray(c) || ((c = Object.keys(c)), (n = Object.keys(n))), !c || !n)
  )
    return !1;
...
function cmplzCopyAttributes(e, t) {
  let c = ["type", "data-service", "data-category", "async"];
  ...
  jQuery(document).ready(function (r) {
    ...
    function t() {
      if (document.querySelector(".cmplz-wp-video-shortcode")) {
        ...
        for (t in a)
          a.hasOwnProperty(t) &&
            i.push('.cmplz-wp-video-shortcode[data-service="' + t + '"]');
        n = i.join(",");
        let c = !1;
        (0 < n.length &&
          document.querySelectorAll(n).forEach((e) => {
            ((c = !0),
              ...
              e.classList.add("wp-video-shortcode", "cmplz-processed"),
            ...
            (t && t.parentElement.removeChild(t),
              e.classList.remove("cmplz-blocked-content-container"));
          }),
          c &&
